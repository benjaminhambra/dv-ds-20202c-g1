...
import ar.edu.davinci.dvds20202cg1.repository.VentaEfectivoRepository;
import ar.edu.davinci.dvds20202cg1.repository.VentaRepository;
import ar.edu.davinci.dvds20202cg1.repository.VentaTarjetaRepository;
...
public class VentaServiceImpl implements VentaService {
	...
	public VentaTarjeta save(VentaTarjeta venta) throws Exception {
		...
		venta = VentaTarjeta.builder().cliente(cliente).fecha(Calendar.getInstance().getTime()).items(items)
				.cantidadCuotas(venta.getCantidadCuotas()).coeficienteTarjeta(new BigDecimal(0.01D)).build();
